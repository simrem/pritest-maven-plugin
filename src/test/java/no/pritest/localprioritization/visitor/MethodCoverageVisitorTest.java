...
public class MethodCoverageVisitorTest {
    ...
    public void setup_MethodDeclarationVisitor_test_object() throws FileNotFoundException, ParseException {
        FileInputStream fis = new FileInputStream("src/main/java/no/pritest/localprioritization/visitor/MethodDeclarationVisitor.java");
		CompilationUnit cu = JavaParser.parse(fis);

        Map<String, ClassType> classesInProject = new HashMap<String, ClassType>();

        ClassType callingClass = new ClassType("no.pritest.localprioritization.visitor", "MethodDeclarationVisitor", null);
        ...
        ClassType thirdClass = new ClassType("no.pritest.localprioritization.visitor", "ReturnTypeVisitor", null);
    ...
    public void should_include_methods_called_by_field_variables() throws ParseException, FileNotFoundException {
    	FileInputStream fis = new FileInputStream("src/test/java/no/pritest/localprioritization/visitor/MethodCoverageVisitorTest.java");
		CompilationUnit cu = JavaParser.parse(fis);
		
		Map<String, ClassType> classesInProject = new HashMap<String, ClassType>();
		
		ClassType classCoverClass = new ClassType("no.pritest.localprioritization.model", "ClassCover", null);
        ...
        ClassType theTestClass = new ClassType("no.pritest.localprioritization.visitor", "MethodCoverageVisitorTest", null);
    ...
    public void should_support_overloaded_method_declarations() throws FileNotFoundException, ParseException {
    	FileInputStream fis = new FileInputStream("src/main/java/no/pritest/localprioritization/visitor/MethodCoverageVisitor.java");
		CompilationUnit cu = JavaParser.parse(fis);
